...
//       try {
//         // The response.data.processed object should contain 'blob_name'
...
//           processed: response.data.processed, // This now contains .blob_name
...
//     try {
//       // Send the proxied URL of the processed image
...
//         images: imagePayload // Send proxied image URLs
//       });
...
//     try {
//       // We send all image data (including .blob_name)
...
//                     // Use the blob_name to build the proxied URL
//                     const blobName = img.processed?.blob_name;
...
//                   {uploadedImages[0] ? (() => {
//                      // 1. Get the BLOB NAME from the processed image data
//                      const blobName = uploadedImages[0].processed?.blob_name;
                     
//                      if (!blobName) {
//                        // Fallback if blob_name is somehow missing
//                        console.error("Critical: 'blob_name' not found in uploaded image data. Falling back to placeholder.");
//                        return <img src={DEFAULT_PLACEHOLDER} alt="Placeholder" className="craft-image" style={{height: '300px', objectFit: 'cover'}} />;
//                      }
                     
//                      // 2. Build the FULL, proxied URL using the blob_name
//                      const fullProxiedUrl = `${API_URL}/api/get-image/${blobName}`;
                       
//                      // 3. Pass the full proxied URL to the ArImageViewer
//                      return (
//                         <ArImageViewer
...
//                      );
//                   })() : (
//                     // Default placeholder if no image is uploaded at all
...
//       setSubmissionResult(response.data);
//       console.log('✅ Story preserved successfully:', response.data);
//       console.log('🔗 Blockchain data:', response.data.blockchain);
//       console.log('📊 Final story scores:', {
//         heritageScore: response.data.story?.heritageScore,
//         rarityScore: response.data.story?.rarityScore
//       });
//       console.log('🎨 NFT data:', response.data.nft);
//     } catch (err) {
//       const errorMessage = err.response?.data?.error || 'Failed to preserve story. Please try again.';
//       setError(errorMessage);
//       console.error('❌ Story preservation failed:', errorMessage);
...
//   if (submissionResult) {
//     const { blockchain, nft, story } = submissionResult;
//     const blockchainPreserved = blockchain && blockchain.status === 'confirmed';
...
//           <div style={{ fontSize: '3rem', marginBottom: '1rem' }}>🎉</div>
//           <h2>Story Preserved Successfully!</h2>
//           <p style={{ marginBottom: '2rem' }}>Your craft story has been added to the Heritage Gallery.</p>
...
//                 <div>
//                   <h3 style={{ margin: 0, fontSize: '1.25rem' }}>Secured on Blockchain</h3>
//                   <p style={{ margin: 0, fontSize: '0.9rem', opacity: 0.9 }}>
//                     Your story is now tamper-proof and permanently preserved
//                   </p>
//                 </div>
//               </div>
...
//                 <div style={{ marginBottom: '0.75rem' }}>
//                   <div style={{ fontSize: '0.85rem', opacity: 0.8, marginBottom: '0.25rem' }}>
//                     Story Hash (Content Fingerprint)
//                   </div>
//                   <div style={{ 
//                     fontFamily: 'monospace', 
//                     fontSize: '0.9rem',
...
//                   <span style={{ fontSize: '2rem' }}>🎨</span>
//                   <div>
//                     <div style={{ fontSize: '0.85rem', opacity: 0.8 }}>Story NFT Minted</div>
//                     <div style={{ fontSize: '1.1rem', fontWeight: 'bold' }}>
//                       Token #{nft.tokenId}
//                     </div>
//                   </div>
...
//                 <span>✅</span>
//                 <span>
//                   Verified at {new Date(blockchain.timestamp).toLocaleString()}
//                 </span>
//               </div>
//             </motion.div>
//           )}
